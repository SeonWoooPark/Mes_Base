...
import { BOMCircularChecker, DefaultBOMCircularChecker } from '../domain/services/BOMCircularChecker';
...
// Application Layer
import { GetBOMTreeUseCase, BOMPresenter } from '../application/usecases/bom/GetBOMTreeUseCase';
  ...
  static initialize(
    ...
    if (useMockData) {
      ...
      diContainer.register(BOM_TOKENS.BOMRepository, {
        useFactory: (c) => new HttpBOMRepository(c.resolve(PRODUCT_TOKENS.ApiClient))
      });
      diContainer.register(BOM_TOKENS.BOMItemRepository, {
        useFactory: (c) => new HttpBOMItemRepository(c.resolve(PRODUCT_TOKENS.ApiClient))
      });
      diContainer.register(BOM_TOKENS.BOMHistoryRepository, {
        useFactory: (c) => new HttpBOMHistoryRepository(c.resolve(PRODUCT_TOKENS.ApiClient))
      });
    }
    ...
    diContainer.register(BOM_TOKENS.BOMCircularChecker, {
      useFactory: (c) => new DefaultBOMCircularChecker(
    ...
    diContainer.register(BOM_TOKENS.BOMUsageChecker, {
      useFactory: (c) => new DefaultBOMUsageChecker(
        c.resolve(BOM_TOKENS.BOMRepository),
        c.resolve(BOM_TOKENS.BOMItemRepository)
      )
    });
    ...
    diContainer.register(BOM_TOKENS.GetBOMTreeUseCase, {
      useFactory: (c) => new GetBOMTreeUseCase(
        c.resolve(BOM_TOKENS.BOMRepository),
        c.resolve(BOM_TOKENS.BOMItemRepository),
    ...
    diContainer.register(BOM_TOKENS.AddBOMItemUseCase, {
      useFactory: (c) => new AddBOMItemUseCase(
        c.resolve(BOM_TOKENS.BOMRepository),
        c.resolve(BOM_TOKENS.BOMItemRepository),
    ...
    diContainer.register(BOM_TOKENS.UpdateBOMItemUseCase, {
      useFactory: (c) => new UpdateBOMItemUseCase(
        c.resolve(BOM_TOKENS.BOMItemRepository),
        c.resolve(BOM_TOKENS.BOMRepository),
        c.resolve(PRODUCT_TOKENS.ProductRepository),
        c.resolve(BOM_TOKENS.BOMHistoryRepository),
    ...
    diContainer.register(BOM_TOKENS.DeleteBOMItemUseCase, {
      useFactory: (c) => new DeleteBOMItemUseCase(
        c.resolve(BOM_TOKENS.BOMItemRepository),
        c.resolve(BOM_TOKENS.BOMRepository),
        c.resolve(BOM_TOKENS.BOMHistoryRepository),
        c.resolve(BOM_TOKENS.BOMUsageChecker),
    ...
    diContainer.register(BOM_TOKENS.CopyBOMUseCase, {
      useFactory: (c) => new CopyBOMUseCase(
        c.resolve(BOM_TOKENS.BOMRepository),
        c.resolve(BOM_TOKENS.BOMItemRepository),
        c.resolve(PRODUCT_TOKENS.ProductRepository),
        c.resolve(BOM_TOKENS.BOMHistoryRepository)
    ...
    diContainer.register(BOM_TOKENS.CompareBOMUseCase, {
      useFactory: (c) => new CompareBOMUseCase(
        c.resolve(BOM_TOKENS.BOMRepository),
        c.resolve(BOM_TOKENS.BOMItemRepository),
        c.resolve(PRODUCT_TOKENS.ProductRepository),
        c.resolve(BOM_TOKENS.BOMHistoryRepository)
...
export const BOMDIDebug = {
  ...
  checkCrossFeatureDependencies(): void {
    ...
    try {
      const productRepo = container.resolve(PRODUCT_TOKENS.ProductRepository) as any;
