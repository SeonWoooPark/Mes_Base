...
export const LazyBOMTreeTable = lazyLoad(
  () => import('../components/bom/BOMTreeTable').then(module => ({ default: module.BOMTreeTable })),
  {
...
export const LazyBOMCompareModal = lazyLoad(
  () => import('../components/bom/BOMCompareModal').then(module => ({ default: module.BOMCompareModal })),
  {
...
export const LazyBOMItemModal = lazyLoad(
  () => import('../components/modals/BOMItemModal').then(module => ({ default: module.BOMItemModal })),
  {
...
export const LazyBOMCopyModal = lazyLoad(
  () => import('../components/modals/BOMCopyModal').then(module => ({ default: module.BOMCopyModal })),
  {
...
export const LazyBOMStatistics = lazyLoad(
  () => import('../components/bom/BOMStatistics').then(module => ({ default: module.BOMStatistics })),
  {
...
export const LazyVirtualizedBOMTree = lazyLoad(
  () => import('../components/bom/VirtualizedBOMTree').then(module => ({ default: module.VirtualizedBOMTree })),
  {
...
export const LazyProductFormModal = lazyLoad(
  () => import('../components/modals/ProductFormModal').then(module => ({ default: module.ProductFormModal })),
  {
...
export const LazyProductTable = lazyLoad(
  () => import('../components/product/ProductTable').then(module => ({ default: module.ProductTable })),
  {
 ...
 */
const requestIdleCallback = window.requestIdleCallback || function(cb: IdleRequestCallback) {
